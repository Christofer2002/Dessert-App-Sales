...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final ApplicationinsightsLibraryAccessors laccForApplicationinsightsLibraryAccessors = new ApplicationinsightsLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>applicationinsights</b>
     */
    public ApplicationinsightsLibraryAccessors getApplicationinsights() {
        return laccForApplicationinsightsLibraryAccessors;
    }
    ...
    public static class ApplicationinsightsLibraryAccessors extends SubDependencyFactory {

        public ApplicationinsightsLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>android</b> with <b>com.microsoft.azure:applicationinsights-android</b> coordinates and
         * with version reference <b>applicationinsightsAndroid</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAndroid() {
            return create("applicationinsights.android");
        }
    ...
    public static class OkhttpLoggingLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>okhttp.logging.interceptor</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>applicationinsightsAndroid</b> with value <b>2.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getApplicationinsightsAndroid() { return getVersion("applicationinsightsAndroid"); }

        /**
         * Version alias <b>benchmarkMacro</b> with value <b>1.3.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>material3</b> with value <b><versión_actualizada></b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Group of versions at <b>versions.ben</b>
         */
        public BenVersionAccessors getBen() {
            return vaccForBenVersionAccessors;
        }
    ...
    public static class BenVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>ben.manes</b> with value <b>0.51.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getManes() { return getVersion("ben.manes"); }
    ...
    public static class OkhttpVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Group of versions at <b>versions.okhttp.logging</b>
         */
    ...
    public static class OkhttpLoggingVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>okhttp.logging.interceptor</b> with value <b>4.11.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        private final BenPluginAccessors paccForBenPluginAccessors = new BenPluginAccessors(providers, config);
        ...
        /**
         * Group of plugins at <b>plugins.ben</b>
         */
        public BenPluginAccessors getBen() {
            return paccForBenPluginAccessors;
        }
    ...
    public static class BenPluginAccessors extends PluginFactory {
        private final BenManesPluginAccessors paccForBenManesPluginAccessors = new BenManesPluginAccessors(providers, config);

        public BenPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of plugins at <b>plugins.ben.manes</b>
         */
        public BenManesPluginAccessors getManes() {
    ...
    public static class BenManesPluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>ben.manes.versions</b> with plugin id <b>com.github.ben-manes.versions</b> and
         * with version reference <b>ben.manes</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getVersions() { return createPlugin("ben.manes.versions"); }
