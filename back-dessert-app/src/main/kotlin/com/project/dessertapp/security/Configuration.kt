package com.project.dessertapp.security

import com.project.dessertapp.Security.JwtAuthenticationFilter
import com.project.dessertapp.Security.JwtAuthorizationFilter
import com.project.dessertapp.security.AppCustomDsl.Companion.customDsl
import com.project.dessertapp.services.AppUserDetailsService
...
class JwtSecurityConfiguration {
    ...
    fun filterChain(http: HttpSecurity): SecurityFilterChain {
        http
            ...
            .authorizeHttpRequests {
                it
                    .requestMatchers(HttpMethod.GET, URL_TASTES).permitAll()
                    .requestMatchers(HttpMethod.POST, URL_TASTES).permitAll()
