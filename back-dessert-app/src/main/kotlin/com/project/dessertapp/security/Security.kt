...
import com.project.dessertapp.dto.UserLoginInput
import com.project.dessertapp.services.CustomUserDetails
...
object SecurityConstants {
    ...
    const val TOKEN_SECRET: String =
        "======================DessertAppDessertAppDessertAppDessertApp==========================="
}
...
class JwtAuthenticationFilter(authenticationManager: AuthenticationManager) : UsernamePasswordAuthenticationFilter() {
    ...
    override fun successfulAuthentication(
        ...
        val userPrincipalWithoutPassword = CustomUserDetails(
            id = userPrincipal.id,
          //  createdDate = userPrincipal.createdDate,
            username = userPrincipal.username,
            enabled = userPrincipal.isEnabled,
            firstName = userPrincipal.firstName,
            lastName = userPrincipal.lastName,
            password = null, // Set password to null here
            tokenExpired = userPrincipal.tokenExpired,
        ...
        out.print(objectMapper.writeValueAsString(userPrincipalWithoutPassword))
        out.flush()
    }
}
